                                ...
                                <form action="ListProductServlet" id="search_product">
                                    ...
                                    <div class="sidebar_widget shop_c" style="margin-bottom: 30px;">
                                        ...
                                        <div class="layere_categorie">
                                            ...
                                            <ul>                                          
                                                <li>
                                                    <input id="tops" type="checkbox" name="genderSearch" value="MALE" 
                                                           <%=searchGender!=null&&searchGender.equals("MALE")?"checked":""%>>
                                                    <label for="tops">Men<span></span></label>
                                                </li>
                                                <li>
                                                    <input id="bag" type="checkbox" name="genderSearch" value="FEMALE" 
                                                           <%=searchGender!=null&&searchGender.equals("FEMALE")?"checked":""%>>
                                    ...
                                    <div class="search_gender sidebar_widget shop_c">
                                        ...
                                        <div class="layere_categorie">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <input id="acces" type="checkbox" name="categorySearch" value="<%=category.getName()%>"
                                                           <%=listSearchCategory!=null&&listSearchCategory.contains(category.getName())?"checked":""%>>
                                    ...
                                    <div class="sidebar_widget price">
                                        ...
                                        <div class="price_range">
                                            <input type="number" name="priceFrom" placeholder="VND From" 
                                                   value="<%=(Double) request.getAttribute("priceFrom")!=null?(Double) request.getAttribute("priceFrom"):"0"%>">
                                            <input type="number" name="priceTo" placeholder="VND To" 
                                                   value="<%=(Double) request.getAttribute("priceTo")!=null?(Double) request.getAttribute("priceTo"):""%>">
                                        </div>
                                    </div>                                                       
                                    <!--price slider end-->
                                    ...
                                    <div class="sidebar_widget shop_c" style="margin-bottom: 30px;">
                                        ...
                                        <div class="layere_categorie">
                                            ...
                                            <ul>                                          
                                                ...
                                                <li>
                                                    <input id="tops" type="checkbox" name="brandSearch" value="<%=brand.getBrandName()%>" 
                                                           <%=listSearchBrand!=null&&listSearchBrand.contains(brand.getBrandName())?"checked":""%>>
